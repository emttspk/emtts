...
const vectors = [
  ...
  {
    name: "Mobile wallet support-aligned field set",
    ...
    fields: {
      ...
      pp_TxnRefNo: "T20260601101112",
      pp_Amount: "100",
      pp_TxnCurrency: "PKR",
      pp_TxnDateTime: "20260601101112",
      pp_BillReference: "BILL-123",
      pp_Description: "Test",
      pp_ReturnURL: "https://example.com",
      pp_TxnExpiryDateTime: "20260608101112",
      ppmpf_1: "03123456789",
    },
  },
];
...
for (const vector of vectors) {
  ...
  console.log("hash length:", actualHash.length);
