...
- Architecture documentation (`docs/system-map.md`, `docs/complaint-architecture.md`)
- Setup guides (`docs/local-bootstrap.md`, `README.md`)
- Technical specifications and runbooks (`docs/mos-render-logic.md`, etc.)
...
```
docs/local-bootstrap.md          → Setup guide (same everywhere)
docs/system-map.md               → Architecture (same everywhere)
