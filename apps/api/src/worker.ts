...
import { buildFilteredTrackingMasterRows, buildTrackingMasterFileName } from "./worker/trackingMaster.js";
...
const worker = new Worker(
  ...
  async (bullJob) => {
    const processJob = async () => {
      ...
      const trackingMasterRows = buildFilteredTrackingMasterRows(jobId, labelOrdersForRender, shipmentType ?? null, resolveOrderShipmentType);
