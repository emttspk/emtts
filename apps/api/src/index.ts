...
router.use("/admin/aggregator-bookings", ensureApiDatabaseConnection, adminAggregatorBookingsRouter);
...
router.use("/analytics", ensureApiDatabaseConnection, analyticsRouter);
