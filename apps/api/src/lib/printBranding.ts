...
export const PRINTABLE_FOOTER_CSS = `.${PRINTABLE_FOOTER_CLASS_NAME}{text-align:center;font-size:14px;font-weight:600;line-height:1.3;width:100%;display:flex;justify-content:center;align-items:center;}`;
