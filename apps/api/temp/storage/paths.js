...
export function moneyOrdersOutputPath(jobId) {
    return path.join(outputsDir(), `${jobId}-money-orders.pdf`);
}
export function toStoredPath(absPath) {
...
export async function waitForStoredFile(storedPath, attempts = 8, delayMs = 200) {
