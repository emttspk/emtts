    ...
    <header className="sticky top-0 z-30 shrink-0 border-b border-[color:var(--line)] bg-white/90 backdrop-blur-2xl">
      <div className="flex min-h-[62px] w-full items-center justify-between gap-3 px-4 py-2 md:px-5">
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <img src="/assets/pakistan-post-logo.png" alt="Pakistan Post" className="hidden h-7 w-auto object-contain md:block" />
          <div className="min-w-0">
            <div className="text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-400">Workspace</div>
            <div className="truncate font-display text-[1.3rem] font-extrabold tracking-[-0.04em] text-[color:var(--text-strong)] md:text-[1.4rem]">{props.title}</div>
          </div>
        </div>
