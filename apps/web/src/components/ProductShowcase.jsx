      ...
      <div className="ui-page">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {showcaseCards.map((card) => (
            <Card key={card.title} data-showcase-card={card.kind} className="overflow-hidden rounded-[30px] border border-slate-200 bg-white p-0 shadow-[0_24px_60px_rgba(15,23,42,0.12)]">
