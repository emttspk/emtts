...
const BILLING_PACKAGES = [
  {
    name: "Starter",
    price: "PKR 4,999/month",
    shipmentLimit: "Up to 2,000 shipments/month",
    moneyOrderLimit: "Up to PKR 300,000 MO value/month",
    trackingAccess: "Real-time tracking and status updates",
    complaintSupport: "Standard complaint support",
  },
  {
    name: "Business",
    price: "PKR 14,999/month",
    shipmentLimit: "Up to 10,000 shipments/month",
    moneyOrderLimit: "Up to PKR 2,000,000 MO value/month",
    trackingAccess: "Priority tracking with export insights",
    complaintSupport: "Priority complaint handling",
  },
  {
    name: "Enterprise",
    price: "Custom annual plan",
    shipmentLimit: "Unlimited shipment processing",
    moneyOrderLimit: "Unlimited money-order processing",
    trackingAccess: "Advanced tracking analytics and SLA views",
    complaintSupport: "Dedicated complaint support channel",
  },
];
