...
export default function Dashboard() {
  ...
  return (
    <PageShell className="space-y-6">
      ...
      <div className="grid min-w-0 w-full gap-4 overflow-hidden xl:grid-cols-12">
        <Card className="min-w-0 w-full overflow-hidden xl:col-span-7 p-6">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            <div className="rounded-2xl border border-[color:var(--line)] bg-[#F8FAFC] p-4">
        ...
        <Card className="min-w-0 w-full overflow-hidden xl:col-span-5 p-6">
      ...
      <div className="grid min-w-0 w-full gap-4 overflow-hidden xl:grid-cols-12">
        <Card className="min-w-0 w-full overflow-hidden xl:col-span-8 p-6">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <button
                ...
                className="rounded-2xl border border-[color:var(--line)] bg-[#F8FAFC] p-4 text-left transition hover:-translate-y-0.5 hover:border-slate-300 hover:bg-white"
              >
        ...
        <Card className="min-w-0 w-full overflow-hidden xl:col-span-4 p-6">
